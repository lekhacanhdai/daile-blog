...
public class PostGrpcServer extends PostGrpcServiceGrpc.PostGrpcServiceImplBase {
  ...
  public void createPost(
      MCreatePostRequest request, StreamObserver<MCreatePostResponse> responseObserver) {
  ...
  public void listPost(
      MListPostRequest request, StreamObserver<MListPostResponse> responseObserver) {
    GrpcServerUtils.execute(
        request,
        responseObserver,
  ...
  public void getPostById(
      IdRequest request, StreamObserver<MGetPostByIdResponse> responseObserver) {
    GrpcServerUtils.execute(
        request,
        responseObserver,
