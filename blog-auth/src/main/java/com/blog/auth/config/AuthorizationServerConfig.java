...
public class AuthorizationServerConfig {
    ...
    public SecurityFilterChain authorizationServerSecurityFilterChain(HttpSecurity http) throws Exception{
        ...
        http.exceptionHandling(e -> e.defaultAuthenticationEntryPointFor(new LoginUrlAuthenticationEntryPoint("/login"),
    ...
    public UserDetailsService customUserDetailService(){
        return new MyUserDetailService(userRepository, roleRepository);
    }
    ...
    public RegisteredClientRepository registeredClientRepository() {
        RegisteredClient oidcClient = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                .redirectUri("http://127.0.0.1:9001/public")
                .postLogoutRedirectUri("http://127.0.0.1:9001/public")
                .scope("openid")
